                            ...
                            <div class="card-body card-form p-4">
                                ...
                                <div class="row">
                                    ...
                                    <div class="mb-4 col-md-6">
                                        ...
                                        <input type="text" value="{{$job->company_location}}" placeholder="Location" id="location" name="company_location"
                                            class="form-control">
                                    </div>
                                </div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" value="{{$job->company_website}}" placeholder="Website" id="website" name="company_website"
                                        class="form-control">
                                </div>
                            </div>
            ...
            $.ajax({
                ...
                success:function(response){
                    if(response['status']==true){
                        ...
                        $("#vacany").removeClass('is-invalid').siblings('p').removeClass('invalid-feedback').html('');
                        ...
                        $("#category").removeClass('is-invalid').siblings('p').removeClass('invalid-feedback').html('');
                            ...
                            if(errors['vacany']){
                                $("#vacany").addClass('is-invalid').siblings('p').addClass('invalid-feedback').html(errors['vacany']);
                            }
                            else{
                                $("#vacany").removeClass('is-invalid').siblings('p').removeClass('invalid-feedback').html('');
                            }
